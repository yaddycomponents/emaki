/**
 * The agent guide. This is the single source of truth: it is served as the
 * `emaki://guide` MCP resource AND mirrored to `AGENTS.md` at the repo root
 * (see scripts/write-agents.mjs). Keep prose short — it is read by a model.
 */
export const AGENT_GUIDE = `# Emaki — agent guide
